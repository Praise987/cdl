...
const Features: React.FC = () => {
  return (
    ...
    <Box>
      <Box sx={{ px: 8, py: 8, bgcolor: "#fff", width: "100%" }}>
        <Typography
          variant="h4"
          sx={{
            fontWeight: 600,
        ...
        >
          Its simple, Plug into our API, confirm salary details, fund your wallet, and start
          giving out loans in no time.
        </Typography>
        ...
        >
          <Box sx={{ flex: 1, display: "flex", flexDirection: "column", gap: 4 }}>
            ...
            <Box sx={{ display: "flex", alignItems: "flex-start", gap: 2 }}>
              ...
              <Box>
                <Typography sx={titleStyle}>Connect with API</Typography>
                <Typography variant="caption" color="text.secondary">
                  Easily integrate your system using our secure, developer-friendly API.
                </Typography>
              </Box>
            </Box>
            ...
            <Box sx={{ display: "flex", alignItems: "flex-start", gap: 2 }}>
              ...
              <Box>
                <Typography sx={titleStyle}>Verify Salary and Employment</Typography>
                <Typography variant="caption" color="text.secondary">
                  Access real-time verified data to confirm borrower income and job status.
                </Typography>
              </Box>
            </Box>
            ...
            <Box sx={{ display: "flex", alignItems: "flex-start", gap: 2 }}>
              ...
              <Box>
                <Typography sx={titleStyle}>Fund Wallet and Book Loans</Typography>
